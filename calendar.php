...
$successMsg = '';
$errorMsg = '';
$eventsFromDB = []; //Initialize a new array to store fetched events

# Handle App Appointment
...
if(isset($_GET["success"])) {
    $successMsg = match($_GET["success"]) {
        ...
        '3' => "🗑️ Appointment deleted succesfully",
        default => ''
    };
}
...
// 🗓️ Fetch all Appointments and Spread over date range
